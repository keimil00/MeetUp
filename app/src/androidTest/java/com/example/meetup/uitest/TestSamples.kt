...
val mockEvent1 = Event(100, "Event1", 500, "2023", 3600, 51.0, 17.0, "Description1", "10")
val mockEvent2 = Event(101, "Event2", 500, "2023", 3600, 51.0, 17.0, "Description2", "11")
val mockEventRequest = NewEventRequestBody("Event3", "2023", 3600, 51.0, 17.0, "Description3", "12")
